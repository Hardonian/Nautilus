...
class DegradedAdapter implements RuntimeAdapter {
  ...
  async capabilities(): Promise<RuntimeCapabilitySnapshot> { return { runtime: this.kind, state: "degraded", streaming: false, tools: false, jsonMode: false, embeddings: false, vision: false, modelCount: 0, degradedReason: "unsupported_environment" }; }
